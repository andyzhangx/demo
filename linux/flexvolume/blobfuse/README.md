# Attention: this page is not maintained any more, blobfuse driver and doc has been moved to [kubernetes-drivers](https://github.com/andyzhangx/kubernetes-drivers/tree/master/flexvolume/blobfuse).
