...
```bash
docker pull mcr.microsoft.com/aks/v2/gpu-provisioner:v0.4.2-1
docker pull mcr.microsoft.com/aks/v2/gpu-provisioner:v0.4.1-1
```
...
docker run --rm mcr.microsoft.com/aks/v2/gpu-provisioner:v0.4.2-1 --help
```
