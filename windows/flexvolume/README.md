## 1. install flex volume driver on all Windows nodes
make a directory under `C:\volumeplugins\test~example.cmd` and put driver file `https://raw.githubusercontent.com/andyzhangx/Demo/master/windows/flexvolume/example.cmd` under `C:\volumeplugins\test~example.cmd`

## 2. specify `volume-plugin-dir` for Windows kubelet service
