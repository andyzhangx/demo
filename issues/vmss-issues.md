...
```
az vmss show -g <RESOURCE_GROUP_NAME> --name <VMSS_NAME> --instance-ids <ID(number)>
```

 - fix it manully by running following command
```
az vmss update-instances -g <RESOURCE_GROUP_NAME> --name <VMSS_NAME> --instance-ids <ID(number)>
```
